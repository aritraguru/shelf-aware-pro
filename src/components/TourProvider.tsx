...
export const TOUR_STEPS: TourStep[] = [
  ...
  { target: "date-simulator-btn", tooltip: "Let's test the AI! Click 'Skip to {{forecastDate}}' to instantly advance time to the predicted stockout date. Notice how the AI proactively prepares an automated message without needing a manual override.", position: "bottom", actionRequired: true },
